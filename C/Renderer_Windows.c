...
int main()
{
 ...
 //Window init
  ...
  //GL init (I <3 FORMATTING!!!!)
   void (*glGenVertexArrays)         (int count, int* buffer)                                                   = (void(*)(int, int*))wglGetProcAddress("glGenVertexArrays");
   void (*glGenBuffers)              (int count, int* buffer)                                                   = (void(*)(int, int*))wglGetProcAddress("glGenBuffers");
   void (*glBindVertexArray)         (int array)                                                                = (void(*)(int array))wglGetProcAddress("glBindVertexArray");
   void (*glBindBuffer)              (uint target, int buffer)                                                  = (void(*)(uint, int))wglGetProcAddress("glBindBuffer");
   void (*glBufferData)              (uint target, int size, void* data, uint usage)                            = (void(*)(uint, int, void*, uint))wglGetProcAddress("glBufferData");
   void (*glVertexAttribPointer)     (int index, int size, uint type, int normalized, int stride, void* offset) = (void(*)(int, int, uint, int, int, void*))wglGetProcAddress("glVertexAttribPointer");
   void (*glEnableVertexAttribArray) (int index)                                                                = (void(*)(int))wglGetProcAddress("glEnableVertexAttribArray");
   int  (*glCreateShader)            (uint type)                                                                = (int(*)(uint))wglGetProcAddress("glCreateShader");
   void (*glShaderSource)            (int shader, int count, char** sources, int* lengths)                      = (void(*)(int, int, char**, int*))wglGetProcAddress("glShaderSource");
   void (*glCompileShader)           (int shader)                                                               = (void(*)(int))wglGetProcAddress("glCompileShader");
   void (*glGetShaderiv)             (int shader, uint param, void* returnval)                                  = (void(*)(int, uint, void*))wglGetProcAddress("glGetShaderiv");
   void (*glGetShaderInfoLog)        (int shader, int buffersz, void* returnsz, void* buffer)                   = (void(*)(int, int, void*, void*))wglGetProcAddress("glGetShaderInfoLog");
   void (*glDeleteShader)            (int shader)                                                               = (void(*)(int))wglGetProcAddress("glDeleteShader");
   int  (*glCreateProgram)           (void)                                                                     = (int(*)())wglGetProcAddress("glCreateProgram");
   void (*glAttachShader)            (int program, int shader)                                                  = (void(*)(int, int))wglGetProcAddress("glAttachShader");
   void (*glLinkProgram)             (int program)                                                              = (void(*)(int))wglGetProcAddress("glLinkProgram");
   void (*glGetProgramiv)            (int program, uint param, void* returnval)                                 = (void(*)(int, uint, void*))wglGetProcAddress("glGetProgramiv");
   void (*glGetProgramInfoLog)       (int program, int buffersz, void* returnval, void* buffer)                 = (void(*)(int, int, void*, void*))wglGetProcAddress("glGetProgramInfoLog");
   void (*glDetachShader)            (int program, int shader)                                                  = (void(*)(int, int))wglGetProcAddress("glDetachShader");
   void (*glDeleteProgram)           (int program)                                                              = (void(*)(int))wglGetProcAddress("glDeleteProgram");
   void (*glUseProgram)              (int program)                                                              = (void(*)(int))wglGetProcAddress("glUseProgram");
   int  (*glGetUniformLocation)      (int program, char* name)                                                  = (int(*)(int, char*))wglGetProcAddress("glGetUniformLocation");
   void (*glClear)                   (uint flags)                                                               = (void(*)(uint))wglGetProcAddress("glClear");
   void (*glDrawElements)            (uint type, int count, uint elemtype, int offset)                          = (void(*)(uint, int, uint, int))wglGetProcAddress("glDrawElements");
   void (*glUniform2f)               (int uniform, float f1, float f2)                                          = (void(*)(int, float, float))wglGetProcAddress("glUniform2f");
   void (*glUniform2fv)              (int uniform, int count, float* values)                                    = (void(*)(int, int, float*))wglGetProcAddress("glUniform2fv");
   void (*glUniform3fv)              (int uniform, int count, float* values)                                    = (void(*)(int, int, float*))wglGetProcAddress("glUniform3fv");
   void (*glViewport)                (int x, int y, int width, int height)                                      = (void(*)(int, int, int, int))wglGetProcAddress("glViewport");
   uint (*glGetError)                (void)                                                                     = (uint(*)())wglGetProcAddress("glGetError");
  //Buffer init
   int vao;
   int objs[2];
  ...
  //Shader init
   ...
   int result, size;
   int vertshader = glCreateShader(0x8B31);         //0x8B31 is GL_VERTEX_SHADER
   ...
   int fragshader = glCreateShader(0x8B30);         //0x8B30 is GL_FRAGMENT_SHADER
