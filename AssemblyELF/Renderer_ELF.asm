defs:
 ...
 ; $$+0xXX (program base + address) is used so that the addresses resolve properly with PIC
...
data:
 ...
 str.loc       db 'loc', 0
 str.cam       db 'cam', 0
 ; Embed the shaders directly into the binary
 vertshader incbin "Shaders/vertshader.txt"
 db 0
 fragshader incbin "Shaders/fragshader.txt"
 db 0
progend: